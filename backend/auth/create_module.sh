...
import (
	"github.com/AdiCahyaSaputra/go-ojol/backend/auth/modules/$MODULE_NAME/service"
	"github.com/AdiCahyaSaputra/go-ojol/backend/auth/modules/$MODULE_NAME/validation"
...
import (
	"github.com/AdiCahyaSaputra/go-ojol/backend/auth/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"github.com/AdiCahyaSaputra/go-ojol/backend/auth/modules/$MODULE_NAME/controller"
