...
[![Go Report Card](https://goreportcard.com/badge/github.com/AdiCahyaSaputra/go-ojol/backend/gateway)](https://goreportcard.com/report/github.com/AdiCahyaSaputra/go-ojol/backend/gateway) [![Go Reference](https://pkg.go.dev/badge/github.com/AdiCahyaSaputra/go-ojol/backend/gateway.svg)](https://pkg.go.dev/github.com/AdiCahyaSaputra/go-ojol/backend/gateway) [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![Release](https://img.shields.io/badge/release-v2.2.0-green.svg)](https://github.com/AdiCahyaSaputra/go-ojol/backend/gateway/releases) <img align="right" width="200" height="200" alt="Go Gin Clean Architecture" src="https://github.com/user-attachments/assets/b7e2f353-bb6b-4ef1-88e9-6ab9bf2b8327" />
...
1. Clone the repository or **Use This Template**
   ```bash
   git clone https://github.com/AdiCahyaSaputra/go-ojol/backend/gateway.git
   ```
...
[![Star History Chart](https://api.star-history.com/svg?repos=AdiCahyaSaputra/go-ojol/backend/gateway&type=date&legend=top-left)](https://www.star-history.com/#AdiCahyaSaputra/go-ojol/backend/gateway&type=date&legend=top-left)
