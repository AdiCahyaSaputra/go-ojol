...
import (
	...
	"github.com/AdiCahyaSaputra/go-ojol/backend/gateway/modules/auth/dto"
	"github.com/AdiCahyaSaputra/go-ojol/backend/gateway/modules/auth/validation"
	userDto "github.com/AdiCahyaSaputra/go-ojol/backend/gateway/modules/user/dto"
