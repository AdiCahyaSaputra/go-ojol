...
const inputFieldStyle = tva({
  base: 'flex-1 text-foreground text-base py-0 h-full placeholder:text-muted-foreground web:outline-none web:cursor-text web:data-[disabled=true]:cursor-not-allowed',
});
